...
Neuroevolution is evolutionary algorithms applied on artificial neural networks (ANN). In the following section I will give an overview of how ANN works.
\\
\\
ANN is a model that is inspired by biological neural networks as observed in brain.
\subsection{NEAT}
