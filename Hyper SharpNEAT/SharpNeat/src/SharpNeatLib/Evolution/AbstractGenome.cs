...
namespace SharpNeatLib.Evolution
{
	abstract public class AbstractGenome : IGenome
	{
        ...
        double[] multiObjectiveFitness = {0,0};
        int multiObjectiveRank = 0;
        double nSGAiiCrowdDist = 0;
        ...
        public double[] MultiObjectiveFitness
        {
            ...
            set
            {
                multiObjectiveFitness = value;
            }
        }

        public int MultiObjectiveRank
        {
            get
            {
                return multiObjectiveRank;
            }
            set
            {
                multiObjectiveRank = value;
            }
        }

        public double NSGAiiCrowdDist
        {
            get
            {
                return nSGAiiCrowdDist;
            }
            set
            {
                nSGAiiCrowdDist = value;
            }
        }
