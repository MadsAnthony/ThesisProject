...
namespace SharpNeatLib.Experiments
{
    ...
    public class MultiThreadedPopulationEvaluator : IPopulationEvaluator
    {
        ...
        public void EvaluatePopulation(Population pop, EvolutionAlgorithm ea)
        {
            ...
            networkEvaluator.endOfGeneration(); // GWM - Update novelty stuff
        }
        ...
        public static void evalNet(Object input)
        {
            ...
            {
                double[] fitnesses = e.NetworkEvaluator.threadSafeEvaluateNetwork(network,sem2);
                e.g.Fitness = Math.Max(fitnesses[0], EvolutionAlgorithm.MIN_GENOME_FITNESS);
                e.g.ObjectiveFitness = fitnesses[1];
            }
