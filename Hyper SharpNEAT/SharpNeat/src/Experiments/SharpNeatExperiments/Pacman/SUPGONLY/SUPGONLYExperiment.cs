...
{
    public class SUPGONLYExperiment : IExperiment 
    {
        private uint inputs;
        ...
        public SUPGONLYExperiment(uint inputs, uint outputs, uint hidden, int cppnInputs, int cppnOutputs)
        {
            this.inputs = inputs;
        ...
        public void ResetEvaluator(IActivationFunction activationFn)
        {
           // populationEvaluator = new SingleFilePopulationEvaluator(new RobotDualNetworkEvaluator(), activationFn);
            populationEvaluator = new SUPGONLYPopulationEvaluator(new SUPGONLYNetworkEvaluator(), activationFn);
        }
