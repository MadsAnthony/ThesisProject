...
{
    public class SUPGONLYPopulationEvaluator : SingleFilePopulationEvaluator
    {
        public static bool requestResolutionUp = false;
        public static bool requestResolutionDown = false;
        public SUPGONLYPopulationEvaluator(INetworkEvaluator eval,IActivationFunction act) : base(eval,act)
        {
            activationFn = act;
        }
