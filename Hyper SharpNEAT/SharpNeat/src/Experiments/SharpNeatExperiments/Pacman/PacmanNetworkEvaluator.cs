...
{
    class PacmanNetworkEvaluator : INetworkEvaluator
    {
        ...
        public static Substrate substrate = new PacmanSubstrate(8,1,8,false);
        ...
        {
            //INetwork network = substrate.generateNetwork(cppn);
            double retries = 3;
            double totalFitness = 0;
            for (int i = 0; i < retries; i++) {
                var pacman = new PacmanAINeural.NeuralPacman();
                ...
                totalFitness += visualizer.returnGameState;
            }
