...
{
    public class SPMMPopulationEvaluator : SingleFilePopulationEvaluator
    {
        public static bool requestResolutionUp = false;
        public static bool requestResolutionDown = false;
        public SPMMPopulationEvaluator(INetworkEvaluator eval,IActivationFunction act) : base(eval,act)
        {
            activationFn = act;
        }
