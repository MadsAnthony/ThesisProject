...
{
    public class SPSUPGExperiment : IExperiment 
    {
        private uint inputs;
        ...
        public SPSUPGExperiment(uint inputs, uint outputs, uint hidden, int cppnInputs, int cppnOutputs)
        {
            this.inputs = inputs;
        ...
        public void ResetEvaluator(IActivationFunction activationFn)
        {
           // populationEvaluator = new SingleFilePopulationEvaluator(new RobotDualNetworkEvaluator(), activationFn);
            populationEvaluator = new SPSUPGPopulationEvaluator(new SPSUPGNetworkEvaluator(), activationFn);
        }
