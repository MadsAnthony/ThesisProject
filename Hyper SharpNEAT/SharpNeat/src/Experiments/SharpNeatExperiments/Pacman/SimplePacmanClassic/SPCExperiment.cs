...
{
    public class SPCExperiment : IExperiment 
    {
        private uint inputs;
        ...
        public SPCExperiment(uint inputs, uint outputs, uint hidden, int cppnInputs, int cppnOutputs)
        {
            this.inputs = inputs;
        ...
        public void ResetEvaluator(IActivationFunction activationFn)
        {
           // populationEvaluator = new SingleFilePopulationEvaluator(new RobotDualNetworkEvaluator(), activationFn);
            populationEvaluator = new SPCPopulationEvaluator(new SPCNetworkEvaluator(), activationFn);
        }
