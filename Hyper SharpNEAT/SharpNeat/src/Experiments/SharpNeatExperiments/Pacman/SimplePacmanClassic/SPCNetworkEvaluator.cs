...
{
    class SPCNetworkEvaluator : INetworkEvaluator
    {
        ...
        public static SPCSubstrate substrate = new SPCSubstrate(6, 1, 6, HyperNEATParameters.substrateActivationFunction);
