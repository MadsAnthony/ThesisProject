...
{
    class FoodGathererSubstrate : Substrate
    {
        public bool concentric=false;

        public FoodGathererSubstrate(uint inputs, uint outputs,bool circle) : base(inputs,outputs,0,ActivationFunctionFactory.GetActivationFunction("SteepenedSigmoid"))
        {
            concentric=circle;
        }
