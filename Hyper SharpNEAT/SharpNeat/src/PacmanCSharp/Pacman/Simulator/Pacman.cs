...
namespace Pacman.Simulator
{
	public class Pacman : Entity
	{
		...
		public void SetPosition(int x, int y, Direction direction) {
            ...
            if (curNode.ShortestPath[nextNode.X, nextNode.Y, (int)Direction.None] != null) {
				while( curNode != nextNode ) {
                    curNode = curNode.GetNode(curNode.ShortestPath[nextNode.X, nextNode.Y, (int)Direction.None].Direction);
