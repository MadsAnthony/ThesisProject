...
namespace Pacman.Simulator
{
	public class Node
	{
		...
		public PathInfo[,,] ShortestPath = new PathInfo[Map.Width, Map.Height, Enum.GetNames(typeof(Direction)).Length];		
		...
		public class PathInfo
		{
			...
			public PathInfo(Direction direction, int distance, Node parentNode = null) {
